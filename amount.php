...
$row2=$res2->fetch_row();
   ...
   if($amt > $row1['5'])
  {
   ...
   else
    {
       ...
       $sac = $row1['1'];
       $rac = $row2['1'];
       $linknew=new mysqli("localhost","root","","bankdetails") or die("DATA NOT FOUND");
    ...
    .msg
 {
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg mb-3">
    ...
    <a href="#" class="navbar-brand">
      ...
      <!-- Logo Text -->
      <span class="text-uppercase font-weight-bold">THE INTERNS BANK</span>
    </a>
  ...
  <?php
  $link1=new mysqli("localhost","root","","bankdetails") or die("DATA NOT FOUND");
  ...
  <div class="card border-dark" style="width: 25rem ;background-color:#c2185b">
    <div class="card-body">
  ...
  $link2=new mysqli("localhost","root","","bankdetails") or die("DATA NOT FOUND");
